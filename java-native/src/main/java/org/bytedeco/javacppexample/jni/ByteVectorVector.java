...
@Name("std::vector<std::vector<uint8_t> >") @Properties(inherit = org.bytedeco.javacppexample.presets.javacpp_example.class)
public class ByteVectorVector extends Pointer {
    ...
    @Index(function = "at") public native @Cast("uint8_t") byte get(@Cast("size_t") long i, @Cast("size_t") long j);
