        ...
        while (offset < dataSize) {
            ...
            if (unitType === 6) {
                ...
                if (payloadType === 5) {
                    ...
                    let dataContent = new Uint8Array(arrayBuffer, dataOffset + curOffset + 1, payloadContentDataLenght);
                    var dataString = "";
                    for (var i = 0; i < dataContent.length; i++) {
                        dataString += String.fromCharCode(dataContent[i]);
                    }
                    let result = {uuid: uuid, data: dataString.replace("\x00", "")};
